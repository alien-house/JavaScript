...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__sildeshow__ = __webpack_require__(329);
...
var instance = new __WEBPACK_IMPORTED_MODULE_1__sildeshow__["a" /* SildeShow */](8000);
instance.init();
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SildeShow; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(124);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_gsap__ = __webpack_require__(330);
...
var SildeShow = function () {
    function SildeShow(duration) {
        _classCallCheck(this, SildeShow);
    ...
    _createClass(SildeShow, [{
        ...
        key: "clickIndicator",
        value: function clickIndicator(num) {
        ...
        key: "durationFunc",
        value: function durationFunc() {
            // console.log(this);
            console.log(this.currentNum);
            var $ssimg = $(".sildeshow-item");
            var $sslist = $(".sildeshow-list").find('li').eq(this.currentNum);
            var $ssPrevlist = $(".sildeshow-list").find('li').eq(this.prevNum);
            $sslist.addClass("current");
            // console.log($ssimg.eq(this.currentNum));
            $ssPrevlist.removeClass("current");
            __WEBPACK_IMPORTED_MODULE_1_gsap__["TweenLite"].killTweensOf($ssimg.eq(this.prevNum));
            __WEBPACK_IMPORTED_MODULE_1_gsap__["TweenLite"].fromTo($ssimg.eq(this.currentNum), 1.5, {
                x: '100px',
                autoAlpha: 0
            }, {
                x: '0',
                autoAlpha: 1,
                ease: __WEBPACK_IMPORTED_MODULE_1_gsap__["Power1"].easeInOut,
                delay: 0.5
            });
            if (this.prevNum >= 0) {
                __WEBPACK_IMPORTED_MODULE_1_gsap__["TweenLite"].to($ssimg.eq(this.prevNum), 1, {
                    x: '-100px',
                    autoAlpha: 0,
                    ease: __WEBPACK_IMPORTED_MODULE_1_gsap__["Circ"].easeIn
                });
            }
